...
public class UserControllerImpl implements UserController {
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasAnyRole('ADMIN','USER')")
    public ResponseEntity<ResponseUserDTO> update(@PathVariable @Positive @NotNull Long id,
    ...
    @PreAuthorize("hasAnyRole('ADMIN','USER')")
    public ResponseEntity<Map<String, String>> setActiveUser(@PathVariable @Positive @NotNull Long id) {
