...
public class PeriodizationConstants {
    ...
    public static final List<ResponsePeriodizationDTO> PERIODIZATION_LIST_RESPONSE = Arrays.asList(
    ...
    public static final UpdatePeriodizationDTO UPDATE_PERIODIZATION = new UpdatePeriodizationDTO("Nome Periodizacao", 4, 1L);
    public static final List<Periodization> PERIODIZATION_LIST = List.of(
            new Periodization(1L, "Nome Periodizacao 1", 4, LocalDateTime.now(), LocalDateTime.now(), LocalDateTime.now(), USER),
            new Periodization(2L, "Nome Periodizacao 2", 4, LocalDateTime.now(), LocalDateTime.now(), LocalDateTime.now(), USER),
            new Periodization(3L, "Nome Periodizacao 3", 4, LocalDateTime.now(), LocalDateTime.now(), LocalDateTime.now(), USER),
            new Periodization(4L, "Nome Periodizacao 4", 4, LocalDateTime.now(), LocalDateTime.now(), LocalDateTime.now(), USER)
    );
}
